...
# proguardFiles setting in build.gradle.kts.kts.kts.kts.kts.kts.kts.kts.kts.kts.kts.kts.kts.kts.kts.kts.kts.kts.kts.
#
...
# Keep application module
-keep class com.zhengzhou.cashflow.core.server.data.serverResources.ApplicationKt {
    public static void module(io.ktor.server.application.Application);
}
...
-keepclassmembers class io.netty.** {
    ...
    static <clinit>();   # Keep static initializers
}

# Do not warn for unused features
...
-dontwarn io.ktor.application.ApplicationCall
-dontwarn io.ktor.features.ContentConverter
-dontwarn io.ktor.features.ContentNegotiation$Configuration
-dontwarn io.ktor.features.ContentNegotiationKt
-dontwarn io.ktor.features.ContentTransformationException
-dontwarn io.ktor.request.ApplicationReceiveRequest
-dontwarn io.ktor.request.ApplicationRequest
-dontwarn io.ktor.request.ApplicationRequestPropertiesKt
