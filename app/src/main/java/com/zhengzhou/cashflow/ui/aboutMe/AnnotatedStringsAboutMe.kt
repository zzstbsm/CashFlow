package com.zhengzhou.cashflow.ui.aboutMe
...
enum class AboutMeAnnotatedStrings(
    ...
    GITHUB(
        text = R.string.AboutMe_GitHub,
        link = R.string.AboutMe_GitHub_link,
        annotatedText = "zzstbsm"
    ),
    LINKEDIN(
        text = R.string.AboutMe_LinkedIn,
        link = R.string.AboutMe_LinkedIn_link,
