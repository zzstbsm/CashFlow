...
fun Route.commonTransactions() {
    get(PageTree.CommonTransactions.route) {
        call.respondHtml {
            pageTemplate(
                pageTitle = PageTree.CommonTransactions.pageTitle,
                tabList = Navigation.getAllTabs(),
                currentTab = Navigation.CommonTransactions,
                cssList = listOf(
                    CSSTree.Base.route,
