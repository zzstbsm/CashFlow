...
import com.zhengzhou.cashflow.database.data.repository.class_implementation.TagTransactionImplementation
...
internal class RepositoryImplementation(
    ...
    TagTransactionInterface by TagTransactionImplementation(dao),
